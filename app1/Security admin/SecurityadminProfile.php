...
<body>
	...
	<div class="main-content">
		...
		<div class="container margintop25">
            ...
            $query = "SELECT * FROM `app_store_admin` WHERE a_email = 'appplusesecurity665@gmail.com'";
            ...
            $data = $rs->fetch_assoc();
                ...
                if (empty($fname) || empty($lname) || empty($mobile)) {
                    ...
                    $query = "UPDATE `app_store_admin` SET a_fname = '$fname', a_lname = '$lname', a_phone_number = '$mobile' WHERE a_email = 'appplusesecurity665@gmail.com'";
                    $rs = mysqli_query($connect, $query);

                    if ($rs) {
                        $message[] = 'Data updated correctly';
                        header('location: SecurityadminProfile.php');
                        exit;
                    } else {
